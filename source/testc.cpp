...
/********************************/
  while ( 1 )
    {
       //!!arg[0]="\\MS1\\MS1ROOT.EXE";
       //!!arg[1]=NULL;
       rc=spawnvp(P_WAIT, "\\MS1\\MS1ROOT.EXE", NULL); //!!!!arg );
    /*   printf("\n rc=%d   \n",rc);   */
       if(rc ==-1)
    ...
    /******arg[0]="\\MS1\\MS1GETDM.EXE";
           arg[1]=NULL;
           rc=spawnvp(P_WAIT, "\\MS1\\MS1GETDM.EXE", arg );
           if(rc ==-1)
              { perror("\nОшибка вызова процесса MS1GETDM: ");
                exit(666);
              };
   *****/  //!!arg[0]="\\MS1\\MS1CIRCT.EXE";
           //!!arg[1]=NULL;
           rc=spawnvp(P_WAIT, "\\MS1\\MS1CIRCT.EXE", NULL); //!!!!arg );
           if(rc ==-1)
      ...
      if( rc == 5 )
         {
           //!!arg[0]="\\MS1\\MS1GETDM.EXE";
           //!!arg[1]=NULL;
           rc=spawnvp(P_WAIT, "\\MS1\\MS1GETDM.EXE", NULL); //!!arg );
           if(rc ==-1)
              { perror("\nОшибка вызова процесса MS1GETDM: ");
                exit(666);
              };
           //!!arg[0]="\\MS1\\MS1DIGIT.EXE";
           //!!arg[1]=NULL;
           rc=spawnvp(P_WAIT, "\\MS1\\MS1DIGIT.EXE", NULL); //!!!!arg );
           if(rc ==-1)
